...
public class CountriesData {
    ...
    public static final List<Answer> COUNTRIES = Arrays.asList(
        ...
        Answer.builder().name("Armenia").country("Armenia").lat(40.0691).lon(45.0382).build(),
        Answer.builder().name("Austria").country("Austria").lat(47.5162).lon(14.5501).build(),
        Answer.builder().name("Azerbaijan").country("Azerbaijan").lat(40.1431).lon(47.5769).build(),
        ...
        Answer.builder().name("Georgia").country("Georgia").lat(42.3154).lon(43.3569).build(),
        ...
        Answer.builder().name("Kazakhstan").country("Kazakhstan").lat(48.0196).lon(66.9237).build(),
        ...
        Answer.builder().name("Turkey").country("Turkey").lat(38.9637).lon(35.2433).build(),
