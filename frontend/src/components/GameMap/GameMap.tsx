        ...
        <div className={classes.container}>
            <APIProvider apiKey={apiKey}>
                <Map
                    ...
                    disableDefaultUI
                >
                    {guesses.map((guess) => <AdvancedMarker key={guess.lat + guess.lng} position={{ lat: guess.lat, lng: guess.lng }} >
                        <Pin background={guess.isCorrect ? colors.success : colors.fail}
                            borderColor={guess.isCorrect ? colors.successDarker : colors.failDarker}
                            glyphColor={guess.isCorrect ? colors.successDarker : colors.failDarker} />
                    </AdvancedMarker>)}
